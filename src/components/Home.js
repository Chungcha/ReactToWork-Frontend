...
return <div className={this.props.searchResults ? "home-background-with-results App container-fluid" : "home-background App container-fluid" } id="home">
      <Search path="/" searchResults={this.props.searchResults} includeRemote={this.props.includeRemote} setSearch={this.props.setSearch} submitSearch={this.props.submitSearch} setFromRemoteOK={this.props.setFromRemoteOK} currentUser={this.props.currentUser} toggleCreatePost={this.props.toggleCreatePost} />
